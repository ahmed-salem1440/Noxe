...
decodeUserData(){
  ...
  changePassword(changeform:any):Observable<any>{
    return this._HttpClient.put('https://route-ecommerce.onrender.com/api/v1/users/changeMyPassword',changeform,{
      headers:this.headers
    })
  }
  changeData(changeform:any):Observable<any>{
    return this._HttpClient.put('https://route-ecommerce.onrender.com/api/v1/users/updateMe/',changeform,{
      headers:this.headers
    })
  }
  logout(){
